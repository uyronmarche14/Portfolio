 ...
 */
export type TechnologyLearningStatus = 'learning' | 'comfortable' | 'proficient' | 'expert';
...
/**
 * Technology summary interface for compact displays
 */
...
/**
 * Technology skill group for organizing skills
 */
 ...
 */
export type UpdateTechnologyInput = Partial<Omit<Technology, 'id' | 'createdAt' | 'updatedAt'>>;
