  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        /> */}
        <div className="absolute right-20 top-20 h-32 w-32 rounded-full bg-gradient-to-r from-primary/10 to-secondary/10 blur-xl" />
        {/* <motion.div
        ...
        /> */}
        <div className="absolute bottom-32 left-16 h-24 w-24 rounded-full bg-gradient-to-r from-secondary/10 to-primary/10 blur-xl" />
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-24">
        ...
        <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12">
          ...
          <div className="space-y-8 lg:col-span-4">
            ...
            > */}
            <div className="rounded-2xl border border-green-500/20 bg-gradient-to-br from-green-500/10 to-emerald-500/10 p-6">
