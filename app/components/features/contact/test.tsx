  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-to-r from-secondary/20 to-accent/20 rounded-full blur-3xl" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-gradient-to-r from-primary/10 to-secondary/10 rounded-full blur-3xl" />
      </div>
        ...
        <div className="relative bg-gradient-to-br from-primary/90 via-secondary/90 to-accent/90 backdrop-blur-xl rounded-3xl py-8 md:py-12 lg:py-16 shadow-2xl border border-border/50 max-w-7xl w-full hover:scale-105">
          ...
          <div className="w-full max-w-7xl text-start space-y-6 md:space-y-8 px-6 md:px-8">
            ...
            <div className="space-y-2 md:space-y-4">
              <h1 className="font-rawkner text-3xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-foreground leading-tight">Let&apos;s Create Something</h1>
              <h2 className="font-rawkner text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-light text-muted-foreground">Remarkable <span className="text-secondary-foreground">Together</span></h2>
            </div>
