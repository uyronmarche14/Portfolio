      ...
      <Drawer direction="right">
        ...
        <DrawerContent className="h-full md:w-[50%] mt-24 ml-auto">
          <DrawerHeader className="flex flex-row items-center justify-between border-b">
            <div>
              <DrawerTitle className="text-xl font-semibold">Music Player</DrawerTitle>
              <DrawerDescription>
          ...
          <div className="flex-1 flex flex-col p-6 space-y-6">
            ...
            <div className="flex items-center justify-center space-x-4">
              <Button
                ...
                className={isShuffled ? "text-blue-500" : "text-muted-foreground"}
              >
              ...
              <Button
                ...
                className={repeatMode !== 'none' ? "text-blue-500" : "text-muted-foreground"}
              >
          ...
          <DrawerFooter className="border-t">
            <div className="flex gap-2 justify-end">
              <Button variant="outline" onClick={toggleShuffle}>
                <Shuffle className={`w-4 h-4 mr-2 ${isShuffled ? "text-blue-500" : ""}`} />
                Shuffle
              </Button>
